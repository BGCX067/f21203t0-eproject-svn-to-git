                ...
                <div class="grid_9">
                    <div class="actionBar">
                        <ul class="table-menu">
                            ...
                            <li><a class="link_text_black active" href="UserValidating" title=""><span>Validating</span></a></li>
                            <li class="last-menu"><a class="link_text_black" href="UserDeclined" title=""><span>Declined</span></a></li>
                        </ul>
                            ...
                            <c:forEach var="u" items="${userV}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="UserDeclinedManage?UserId=${u.userId}" title=""><img src="../templates/admin/images/btnDecline.png" alt=""></a>
                                    </td> 
                                </tr>
                            </c:forEach> 
                        </tbody>
                    ...
                    <div class="pagination" id="page-nav" style="margin-bottom: 20px;">
                        <c:if test="${currentPage != 1}">
                            <a href="${baseURL}/admin/UserValidating?page=${currentPage - 1}">Previous</a>
                        </c:if>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                <c:when test="${currentPage eq i}"><span>${i}</span></c:when>
                                <c:otherwise><a href="${baseURL}/admin/UserValidating?page=${i}">${i}</a></c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:if test="${currentPage lt noOfPages}">
                            <a class="pager-next" href="${baseURL}/admin/UserValidating?page=${currentPage + 1}">Next</a>
                        </c:if> 
                    </div>
                </div>
                <!-- EOF MAIN CONTENT -->
