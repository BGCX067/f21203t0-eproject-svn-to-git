 ...
 * @author admin
 */
public class ImagesManage extends HttpServlet {
    @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int image_id  =   Integer.parseInt(session.getAttribute("image_id").toString());
            Images image  =   imagesFacade.find(image_id);
