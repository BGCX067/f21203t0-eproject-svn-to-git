 ...
 * @author Tuan
 */
@WebServlet(name = "SendFeeback", urlPatterns = {"/SendFeeback"})
public class SendFeeback extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            String su = request.getParameter("txtSubject");
           String mes = request.getParameter("txtmessage");
