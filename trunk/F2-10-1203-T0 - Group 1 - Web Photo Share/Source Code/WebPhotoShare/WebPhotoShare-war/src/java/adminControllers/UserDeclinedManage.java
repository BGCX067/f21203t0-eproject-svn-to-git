 ...
 * @author Hung Nguyen
 */
public class UserDeclinedManage extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            email.emailUserStatus(user.getName(), user.getEmail(), false);
            
            user.setUserStatus((short) 2);
            usersFacade.edit(user);
            request.setAttribute("redirectMessage", "User declined successful!");
